...
const Offer: React.FC = () => {
  ...
  useEffect(() => {
    const OfferScroll = () => {
      const { top: top1 } =
        animatedElementRef1.current!.getBoundingClientRect();
      const { top: top2 } =
        animatedElementRef2.current!.getBoundingClientRect();
      const { top: top3 } =
        animatedElementRef3.current!.getBoundingClientRect();
      const { top: top4 } =
        animatedElementRef4.current!.getBoundingClientRect();
      const { top: top5 } =
        animatedElementRef5.current!.getBoundingClientRect();
      const { top: top6 } =
        animatedElementRef6.current!.getBoundingClientRect();
      const { top: top7 } =
        animatedElementRef7.current!.getBoundingClientRect();
      const { top: top8 } =
        animatedElementRef8.current!.getBoundingClientRect();
      const { top: top9 } =
        animatedElementRef9.current!.getBoundingClientRect();
      const { top: top10 } =
        animatedElementRef10.current!.getBoundingClientRect();
      const { top: top11 } =
        animatedElementRef11.current!.getBoundingClientRect();
      const { top: top12 } =
        animatedElementRef12.current!.getBoundingClientRect();
      const { top: top13 } =
        animatedElementRef13.current!.getBoundingClientRect();
      const { top: top14 } =
        animatedElementRef14.current!.getBoundingClientRect();
      const { top: top15 } =
        animatedElementRef15.current!.getBoundingClientRect();
      const { top: top16 } =
        animatedElementRef16.current!.getBoundingClientRect();
      const { top: top17 } =
        animatedElementRef17.current!.getBoundingClientRect();
      const { top: top18 } =
        animatedElementRef18.current!.getBoundingClientRect();
      const { top: top19 } =
        animatedElementRef19.current!.getBoundingClientRect();
      const { top: top20 } =
        animatedElementRef20.current!.getBoundingClientRect();
      const { top: top21 } =
        animatedElementRef21.current!.getBoundingClientRect();
    ...
    <>
      ...
      <>
        ...
        <>
          ...
          >
            <S.IdaFirst1>신입생의 입학 절차를 도와줄</S.IdaFirst1>
          </S.IdaFirstWrap2>
          <S.IdaFirstWrap3
            ref={animatedElementRef7}
            style={{
          ...
          <S.IdaFirstWrap4>
            ...
            >
              <S.IdaFirstIdaSite> 입학원서 접수 사이트</S.IdaFirstIdaSite>
              입니다.
            </S.IdaFirst>
          </S.IdaFirstWrap4>
        </>
      ...
      <>
        ...
        >
          <S.LessflowThTitle>
            {" "}
            <S.Lessflowless>lessf!ow</S.Lessflowless>를 더하세요{" "}
          </S.LessflowThTitle>
        </S.LessflowThWrap1>
      </>
      <S.ButtonWrap>
